...
const Navbar = () => {
    ...
    return (
        <nav className={`h-0 top-0 left-0 w-[100%] z-50 bg-white ${scrollact?"fixed navscroll":"sticky xl:bg-transparent"}`}>
            <div className='w-[100%] xl:w-[70%] 2xl:w-[65%] xl:mx-auto min-h-2 xl:py-4 flex xl:flex-row justify-between xl:h-fit bg-white xl:bg-transparent items-center'>
                <div className={`text-[#ff4500] ${scrollact?"xl:text-black":"xl:text-white"} my-[30px]  font-bold text-4xl xl:text-5xl flex  items-center gap-2 xl:pb-0`}>
                    <img src="https://cdn-icons-png.flaticon.com/512/38/38464.png" alt="" className={`w-[30px] xl:w-[60px] xl:h-[60px] h-[30px]   ${scrollact?"xl:invert-[0]":"xl:invert-[1]"} rotate-90`} />
                    FitLife
                </div>
            ...
            <div className={`h-[100vh] w-[100%] absolute top-0 left-0 bg-[#ff4500] naventry ${navshow?"":"hidden"}`}>
                <div className='flex flex-col mt-[80px] xl:flex-row xl:items-center gap-10'>
